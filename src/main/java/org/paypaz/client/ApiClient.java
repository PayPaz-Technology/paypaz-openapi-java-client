...
import org.paypaz.client.auth.Authentication;
import org.paypaz.client.auth.HttpBasicAuth;
import org.paypaz.client.auth.HttpBearerAuth;
import org.paypaz.client.auth.ApiKeyAuth;
...
public class ApiClient {
     ...
     * @return a {@link org.paypaz.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws org.paypaz.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws org.paypaz.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws org.paypaz.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws org.paypaz.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws org.paypaz.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws org.paypaz.client.ApiException If fail to serialize the request body object
     */
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        processSign(path, method, updatedQueryParams, collectionQueryParams, body, reqBuilder);
     ...
     * @param uri URI
     * @throws org.paypaz.client.ApiException If fails to update the parameters
     */
     ...
     * @throws org.paypaz.client.ApiException If fail to serialize the request body object into a string
     */
    ...
    private void processSign(String path, String method, List<Pair> queryParams,
                             List<Pair> collectionQueryParams, Object body, Request.Builder reqBuilder) {
        if ("GET".equals(method)){
            String postSign = genGetSign(queryParams, collectionQueryParams, path);
            reqBuilder.header("PAYPAZ-ACCESS-KEY", API_KEY);
            reqBuilder.header("PAYPAZ-ACCESS-SIGN", postSign);
            reqBuilder.header("PAYPAZ-ACCESS-TIMESTAMP", TIMESTAMP);
            reqBuilder.header("PAYPAZ-ACCESS-RECV-WINDOW", RECV_WINDOW);
        }
        if ("POST".equals(method)){
            ...
            String postSign = genPostSign(content, path);
            reqBuilder.header("PAYPAZ-ACCESS-KEY", API_KEY);
            reqBuilder.header("PAYPAZ-ACCESS-SIGN", postSign);
            reqBuilder.header("PAYPAZ-ACCESS-TIMESTAMP", TIMESTAMP);
            reqBuilder.header("PAYPAZ-ACCESS-RECV-WINDOW", RECV_WINDOW);
     ...
     */
    private  String genPostSign(String paramJson, String requestPath)  {
     ...
     */
    private  String genGetSign( List<Pair> queryParams, List<Pair> collectionQueryParams,String path) {
        StringBuilder queryStr = genQueryStr(path,queryParams,collectionQueryParams);
     ...
     * @return
     */
    private  StringBuilder genQueryStr(String path,List<Pair> queryParams, List<Pair> collectionQueryParams) {
        final StringBuilder url = new StringBuilder();
        if (queryParams != null && !queryParams.isEmpty()) {
            // support (constant) query string in `path`, e.g. "/posts?draft=1"
            String prefix = path.contains("?") ? "&" : "?";
